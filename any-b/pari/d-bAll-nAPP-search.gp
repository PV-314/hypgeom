...
do_a_b_d_t_u_work(a,b,d,nrmA,t,u,dbg=0)={
	my(bigK,c2,isChecked,k,yCurr,ykLB,ykUB,yM1Step1UB,yM1Step2UB,yM1Step3UB,yM1Step4UB,yM1UB,yPrev,yT);
	...
	yM1Step3UB=59.2*(2*49.8*b*b*b*b*sqrtNA/d)^(1/3)*(sqrtNA*sqrtNA*sqrtNA/sqrt(d))/4;
	yM1Step3UB=max(yM1Step3UB,59.2*(2*49.8*b*b*b*b*sqrtNA/d)^(1/5)*(sqrtNA*sqrtNA*sqrtNA/sqrt(d))/4);
	yM1Step3UB=max(yM1Step3UB,59.2*(2*49.8*b*b*b*b*sqrtNA)^(1/7)*(sqrtNA*sqrtNA*sqrtNA/sqrt(d))/4);

	\\ from equation (4.21)
	yM1Step4UB=65.32*(422*b*b*b*b*abs(nrmA)/d)^(1/2)*(sqrtNA*sqrtNA*sqrtNA/sqrt(d))/4;
	yM1Step4UB=max(yM1Step3UB,65.32*(422*b*b*b*b*abs(nrmA)/d)^(1/4)*(sqrtNA*sqrtNA*sqrtNA/sqrt(d))/4);
	yM1Step4UB=max(yM1Step3UB,65.32*(422*b*b*b*b*abs(nrmA))^(1/6)*(sqrtNA*sqrtNA*sqrtNA/sqrt(d))/4);
	...
	if(isChecked==0,
		...
		while(isChecked==0 && yCurr<yM1UB,
			...
			if(bigK!=0 && k<bigK && issquare(yCurr),
